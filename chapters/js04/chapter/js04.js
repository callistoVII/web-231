...
let E3250Desc =
  'A workhorse for a small farm or a big backyard. A medium- to heavy-duty tractor that can haul whatever you throw at it year-round.';
let E2600Desc =
...
let W1205Desc =
  "Can't be beat for the general tasks of a large farm. Medium- to heavy-duty muscle that's there then you need it.";
let W2500Desc =
  'Our heavy-duty tractor designed especially for the needs of wheat, corn, and soy farmers. A reliable piece of equipment that you can turn to all year long.';
let W2550Desc =
  'Our heavy-duty tractor for general use. A reliable piece of equipment that you can turn to all year long.';
...
function createRecommendation() {
  if (acresBox.value <= 5000) {
    ...
    if (monthsBox.value <= 9) {
      ...
      // 10+ months of farming per year
      if (
        document.getElementById('wheat').checked ||
